...
dts = await fetch('https://flashsave.net/wp-json/aio-dl/video-data/', { method: 'POST', body: postdata });
if (dts.status !== 200) return { status: dts.status, creator: 'Caliph', result: null };
